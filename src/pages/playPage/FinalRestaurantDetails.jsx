...
const FinalRestaurantDetails = ({
  ...
  return (
    <div className="final-restaurant-details text-white font-DalseoHealing font-bold p-14">
      ...
      <div className="w-full h-full max-w-[500px] max-h-[300px] gap-2 col-span-1 row-span-1 justify-center items-center overflow-auto overflow-y-auto scrollbar-hide p-4 mx-auto">
