...
const ModeOneExpainModal = ({ SetShowVoiceRecorder, onShowModal }) => {
  ...
  return (
    <div className="modal fixed top-1/3 left-0 w-full flex items-center justify-center ">
      <div className="modal-container bg-white md:max-w-xl mx-auto rounded-lg shadow-lg  animate-fade">
        {/* Add modal content here */}
        <div className="modal-content py-4 text-left px-6">
          <div className="flex justify-between items-center pb-3">
            <p className="text-3xl font-DalseoHealing font-bold">
          ...
          <div className="mt-4 flex justify-end">
            <button
              onClick={handleClick}
              className="px-4 bg-purple-500 text-xl p-3 ml-3 rounded-lg text-white hover:bg-purple-400 font-DalseoHealing font-bold"
            >
              음성 인식 시작하기
            </button>
          </div>
