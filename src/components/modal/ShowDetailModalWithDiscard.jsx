...
const ShowDetailModalWithDiscard = ({
  restaurant,
  closeModal,
  ...
  return (
    <div>
      <div className="fixed z-10 w-full h-full -top-10 left-0 flex items-center justify-center  ">
        {/* overlay  */}
        ...
        <div className=" bg-white w-11/12 md:max-w-md mx-auto rounded-lg shadow-lg  animate-fade">
          ...
          <div className=" py-4 text-left px-6 font-bold font-DalseoHealing">
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                onClick={() => removeFromPlayerHand(restaurant._id)}
...
export default ShowDetailModalWithDiscard;
